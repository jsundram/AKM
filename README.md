...
1. **New repo** → github.com → **+** → *New repository*. Name it e.g. `AKM`, Public, no README. Create.
...
3. **Enable Pages** → *Settings → Pages* → Source: **Deploy from a branch**, Branch: **main**, folder **/(root)**. Save. After a minute it gives you a URL like `https://<you>.github.io/AKM/`.
